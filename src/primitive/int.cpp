...
SOFTLOQ_WHATWG_INFRA_API infra_int8::infra_int8(const std::int32_t value) noexcept : value(static_cast<std::int8_t>(value)) {}
...
SOFTLOQ_WHATWG_INFRA_API infra_int8& infra_int8::operator=(const std::int32_t value) noexcept { infra_int8::value = static_cast<std::int8_t>(value); return *this; }
...
SOFTLOQ_WHATWG_INFRA_API infra_int16::infra_int16(const std::int32_t value) noexcept : value(static_cast<std::int16_t>(value)) {}
...
SOFTLOQ_WHATWG_INFRA_API infra_int16& infra_int16::operator=(const std::int32_t value) noexcept { infra_int16::value = static_cast<std::int16_t>(value); return *this; }
