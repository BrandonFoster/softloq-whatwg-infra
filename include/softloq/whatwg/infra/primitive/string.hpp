...
public:
    ...
    SOFTLOQ_WHATWG_INFRA_API const code_unit_container_type& code_units() const noexcept;
    SOFTLOQ_WHATWG_INFRA_API const code_point_container_type& code_points() const noexcept;
    ...
    SOFTLOQ_WHATWG_INFRA_API code_unit_container_type::size_type code_unit_size() const noexcept;
    SOFTLOQ_WHATWG_INFRA_API code_point_container_type::size_type code_point_size() const noexcept;
    ...
    SOFTLOQ_WHATWG_INFRA_API void skip_spaces(code_point_container_type::size_type& point_pos) const noexcept;
