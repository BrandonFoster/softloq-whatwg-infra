...
public:
    ...
    SOFTLOQ_WHATWG_INFRA_API explicit infra_byte(const char value) noexcept;
    /**
     * @brief constructs a WHATWG infra byte primitive from a value.
     * @param value the value that will be used. */
    SOFTLOQ_WHATWG_INFRA_API infra_byte(const std::uint8_t value) noexcept;
    /**
     * @brief constructs a WHATWG infra byte primitive from a value.
     * @param value the value that will be used. */
    ...
    /**
     * @brief constructs a WHATWG infra byte primitive from the L-value of a value.
     ...
     * @param value the value that will be used. */
    SOFTLOQ_WHATWG_INFRA_API infra_byte& operator=(const char value) noexcept;
    /**
     * @brief assigns a WHATWG infra byte primitive from a value.
     * @param value the value that will be used. */
    SOFTLOQ_WHATWG_INFRA_API infra_byte& operator=(const std::uint8_t value) noexcept;
    /**
     * @brief assigns a WHATWG infra byte primitive from a value.
     * @param value the value that will be used. */
    ...
    /**
     * @brief assigns a WHATWG infra byte primitive from the L-value of a value.
     * @param value the value that will be moved. */
    ...
    /** @brief gets the C++ char representation. */
    SOFTLOQ_WHATWG_INFRA_API explicit operator char() const noexcept;
